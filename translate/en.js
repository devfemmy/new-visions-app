const English = {
  ...
  // Book One Lesson
  PleaseChoosetheLessonYouWanttoSuscribeto: 'Please Choose The Lesson You Want To Subscribe To: ',
  SubscribeToPrivateCourse: 'Subscribe to private Course',
...
PackagesSubscriptions: 'Package Subscription',
  ...
  ConfrimCodeSend: 'Kindly Enter Verification Code to finish Signing up',
  VerificationCode: 'Verification Code',
  SendVerificationCodeByEmail:
  'Send reset password code by E-mail',
SendVerificationCodeByPhone:
'Send reset password code by phone number',
...
PasswordChangeComplete: 'The password has been successfully changed successfully',
