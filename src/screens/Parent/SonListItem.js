...
export default function SonListItem({name, status, subClick, attendanceClick}) {
  return (
    <View style={styles.rowItem}>
      ...
      <View>
        ...
        <View style={{flexDirection:'row', marginHorizontal:20, marginTop:5}}>
            <View>
                <TouchableOpacity style={styles.btnStyle} onPress={subClick} >
                    <Text style={styles.btnTxt}>{I18n.t("Subscriptions") }</Text>
                </TouchableOpacity>
            </View>
            <View>
                <TouchableOpacity style={[styles.btnStyle, {backgroundColor:colors.dark, marginHorizontal:10}]} onPress={attendanceClick} >
                    <Text style={styles.btnTxt}>{I18n.t("Attendace")}</Text>
                </TouchableOpacity>
            </View>
        </View>}
      </View>
