...
export default function SonAttendanceItem({id, time, date, title, description, videoClick, index}) {
  ...
  return (
    <View style={styles.outContainer}>
      ...
      <View style={{justifyContent:'space-between', padding:5,width:'60%', alignItems:'flex-start'}} >
      ...
      <View style={{justifyContent:'space-between', padding:5,width:'40%', alignItems:'flex-start'}} >
        ...
        <TouchableWithoutFeedback onPress={()=>{videoClick();}}>
            <View style={{flexDirection:'row', width:100,minHeight:30, paddingVertical: heightp(2), backgroundColor:colors.primary, alignItems:'center', justifyContent:'center', borderRadius:10}}>
